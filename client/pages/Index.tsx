  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <main>
        ...
        <div className="hidden lg:flex-1 lg:flex lg:flex-row-[auto_auto] items-center h-screen justify-center px-4 md:px-8 lg:px-[225px] py-12 md:py-16 lg:py-[200px] gap-6">
