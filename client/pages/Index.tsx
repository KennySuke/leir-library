  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <main>
        ...
        <div className="hidden lg:flex-1 lg:grid lg:grid-row-[auto_auto] items-center min-h-screen justify-center px-4 md:px-8 lg:px-[225px] py-12 md:py-16 lg:py-[200px] gap-6">
          <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_1.3fr_1fr] gap-6 md:gap-8 lg:gap-[36px] items-center justify-start mx-auto">
            {/* Left Text */}
