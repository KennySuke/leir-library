                  ...
                  <div className="w-full max-w-[1306px] flex flex-col items-center justify-center gap-[10px]">
                    <div className="flex flex-col gap-6 lg:gap-[30px] w-full px-2 lg:px-[161px]">
                      ...
                      <div className="flex flex-col gap-0 lg:gap-[-2px]">
                        <h1 className="text-4xl md:text-5xl lg:text-[77px] font-bold leading-none text-center">
                          EYE CORNER
                        </h1>
                      ...
                      {/* Info box */}
                      <div className="border-2 border-white/70 p-4 lg:p-[16px_21px] w-full max-w-[545px] mx-auto">
                      ...
                      <div className="text-base md:text-lg lg:text-xl text-justify leading-relaxed">
                        Проект Eye corner исследует концепцию цифрового паноптикума
                        через интерактивный опыт, где записи с онлайн-камер видны
                        только в периферийном зрении посетителей, вызывая ощущение
                        постоянного наблюдения и тревоги. Этот метод символизирует,
                        как цифровые технологии становятся неотъемлемой частью нашего
                        подсознательного восприятия мира, создавая чувство
                        неуверенности и паранойи, и заставляет задуматься о влиянии
                        технологий на наше чувство свободы и безопасности.
                        Инсталляция также опирается на теорию Мишеля Фуко о
                        биополитике, подчеркивая, как методы наблюдения и контроля
                        становятся инструментами управления и регулирования
                        человеческого поведения на уровне популяции.
                      </div>
                    </div>
                  </div>
                </div>
