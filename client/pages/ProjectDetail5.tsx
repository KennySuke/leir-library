      ...
      <main className="w-full">
        <div className="flex flex-col items-center gap-10 lg:gap-[120px] pt-40 lg:pt-[200px] pb-20">
          ...
          <div className="flex flex-col items-center gap-0 lg:gap-[-38px] w-full">
            <div className="flex flex-col lg:flex-row justify-between items-start w-full px-4 lg:pl-[150px] lg:pr-0">
              {/* Left content */}
              <div className="flex flex-col gap-6 lg:gap-[30px] w-full lg:w-1/2 order-2 lg:order-1">
                {/* Title and year */}
              ...
              {/* Right image */}
              <div className="w-full lg:w-[1300px] order-1 lg:order-2 relative z-10">
                <BlurUpImage
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end gap-8 lg:gap-12 w-full lg:pr-[180px]">
            ...
            <div className="w-full lg:w-[564px] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              радикальными жестами Пьеро Мандзони, который когда-то предложил
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12 w-full px-4 lg:px-[262px]">
            ...
            <div className="w-full lg:w-[550px] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              <br />
              от живых кукол (Growing Semi-Living Sculptures) и «бескровной
              кожи» (Victimless Leather) Oron Catts и Ionat Zurr — до проекта
              Ouroboros Steak (Andrew Pelling, Orkan Telhan и Grace Knight), где
              искусственное мясо становится метафорой человеческой
              идентичности.
              <br />
              <br />
              Мы читали о сомнениях и разрывах между искусством и наукой, о том,
              как
              <span className="font-bold">
                {' '}
