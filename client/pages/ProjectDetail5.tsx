        ...
        <div className="flex flex-col items-center gap-10 lg:gap-[120px] pt-40 lg:pt-[200px] pb-20">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12 w-full px-4 lg:pl-[150px] lg:pr-0">
              ...
              <div className="flex flex-col gap-6 lg:gap-[30px] w-full lg:w-[866px] order-2 lg:order-1">
                ...
                <div className="border-2 border-white/70 p-4 lg:px-[21px] lg:py-[16px] w-full lg:w-[545px]">
                  <div className="text-lg lg:text-xl mb-0">
                    <span className="font-bold">
                      Leir, Виктор Кертанов,
                      <br />
                      Дарья Сетевинец, Сизенов Александр
                    </span>
                    <br />
                    <span className="font-normal">Объект (1 шт.), 100х55x55 мм</span>
                  </div>
                ...
                <div className="text-base md:text-lg lg:text-xl text-justify leading-relaxed">
                  ...
                  инструментом для создания физического высказывания. В контексте
                  современного стремления к "натурализации", "экологичности" и
                  "прогрессивности" с заботой о себе, группа художников не
                  обходит стороной и повсеместную практику нативной рекламы
                  БАДов, суперфудов и других «продуктов для тела и разума».
                  <br />
                  <br />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12 w-full px-4">
            ...
            <div className="w-full lg:w-[564px] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              понятие{" "}
              <span className="font-bold">художественного объекта</span>, его
              ценности и границ.
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12 w-full px-4 lg:px-[262px]">
            ...
            <div className="w-full lg:w-[550px] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              стыке{" "}
              <span className="font-bold">искусства и биотехнологий</span>: от
              живых кукол и «бескровной кожи» Орона Каца и Ионат Дзур до проекта
              «Ауроборос» Оркана Тельхана, где искусственное мясо становится
              метафорой человеческой идентичности. Мы читали о сомнениях и
              разрывах между искусством и наукой, о том, как{" "}
              <span className="font-bold">
          ...
          {/* Section: Text + Rotated lab image */}
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12 w-full px-4 lg:px-[318px]">
            <div className="w-full lg:w-[365px] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              <span className="font-bold">даже художник становится товаром</span>
              .
            </div>
          ...
          <div className="relative w-full px-4 h-auto lg:h-[900px]">
