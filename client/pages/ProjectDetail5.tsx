      ...
      <main className="w-full">
        <div className="flex flex-col items-center gap-10 lg:gap-[120px] pt-40 lg:pt-[200px] pb-20">
                ...
                <div className="border-2 border-white/70 p-4 lg:px-[21px] lg:py-[16px] w-full lg:w-[545px]">
                  <div className="text-lg lg:text-xl mb-0">
                    <span className="font-bold">
                      Leir, <a className="underline decoration-white underline-offset-2 hover:opacity-80 transition-opacity" href="https://kertanov.cc/" target="_blank" rel="noopener noreferrer">Виктор Кертанов</a>,
                      <br />
                      <a className="underline decoration-white underline-offset-2 hover:opacity-80 transition-opacity" href="https://dariasetevinets.com/main" target="_blank" rel="noopener noreferrer">Дарья Сетевинец</a>, Сизенов Александр
                    </span>
                    <br />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end gap-8 lg:gap-12 w-full px-4 lg:pr-[180px]">
            <div className="w-full lg:relative lg:left-1/2 lg:right-1/2 lg:-translate-x-1/2 lg:w-screen">
              <BlurUpImage
