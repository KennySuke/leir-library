    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="w-full">
        <div className="flex flex-col items-center gap-10 lg:gap-[120px] pt-40 lg:pt-[200px] pb-20">
          ...
          <div className="flex flex-col lg:flex-row  items-center lg:items-left w-full gap-100 lg:gap-0 px-4 lg:px-[246px]">
            <div className="w-full aspect-video">
              <iframe
                ...
                allowFullScreen
                className="w-full lg:w-[592px] aspect-[2/1] lg:aspect-[592/1052] object-cover"
              />
            </div>
