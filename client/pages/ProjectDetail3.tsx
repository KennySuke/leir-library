        ...
        <div className="flex flex-col items-center gap-10 lg:gap-[120px] pt-40 lg:pt-[200px] pb-20">
          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-center gap-4 lg:gap-[42px] w-full h-[50%] px-4 overflow-x-auto">
            <img
              ...
              alt="Gallery image 1"
              className="w-[15%] aspect-[290/1152] object-cover flex-shrink-0"
            />
            <img
            ...
            <img
              ...
              alt="Gallery image 3"
              className="w-[13%] aspect-[556/950] object-cover flex-shrink-0"
            />
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/934ea473b1bf9ecd95ab3fbbea02d65fa92e5d60?width=658"
              alt="Gallery image 4"
              className="w-[15%] aspect-[329/988] object-cover flex-shrink-0"
            />
            <img
            ...
            <img
              ...
              alt="Gallery image 6"
              className="w-[15%] aspect-[359/1074] object-cover flex-shrink-0"
            />
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/9001e0a815ce23f0dab678aba415219b98360f39?width=1196"
              alt="Gallery image 7"
              className="w-[15%] aspect-[598/988] object-cover flex-shrink-0"
            />
            <img
