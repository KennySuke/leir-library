    ...
    >
      <div className="flex items-center justify-center max-w-[1920px] mx-auto px-2 py-0 md:px-2 lg:px-4 h-[150px]">
        <nav className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] justify-center items-center relative">
          ...
          {/* CENTER LOGO */}
          <div className="flex items-center justify-center gap-0 md:gap-2 lg:gap-[5px] my-0lg:my-0">
            {/* PROJS */}
            <Link
              to="/projects"
              onMouseEnter={() => handleHover("left", true)}
              ...
              className="text-text-accent text-3xl md:text-3xl lg:text-[40px] whitespace-nowrap hover:opacity-70 transition-opacity z-50"
            >
              PROJS
            </Link>
