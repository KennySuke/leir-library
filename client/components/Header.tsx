...
export default function Header() {
  ...
  return (
    <header className="w-full bg-black/1 fixed top-0 left-0 z-50">
      <div className="flex items-center justify-center max-w-[1920px] mx-auto px-2 py-0 md:px-2 lg:px-4 h-[150px]" style={{ boxShadow: "-50px -60px 80px 40px rgba(0, 0, 0, 1)" }}>
